...
static ParamBlockDesc2 param_blk(
	...
	//rollout
	ns_mat_ambient, _T("ambient"), TYPE_RGBA, 0, IDS_MAT_AMBIENT,
		p_default, Color(0.0f, 0.0f, 0.0f),
		//p_ui, basic_params, TYPE_COLORSWATCH, IDC_CLR_AMBIENT,
		p_end,
	ns_mat_diffuse, _T("diffuse"), TYPE_RGBA, 0, IDS_MAT_DIFFUSE,
		p_default, Color(0.5f, 0.5f, 0.5f),
		//p_ui, basic_params, TYPE_COLORSWATCH, IDC_CLR_DIFFUSE,
		p_end,
	ns_mat_specular, _T("specular"), TYPE_RGBA, 0, IDS_MAT_SPECULAR,
		p_default, Color(1.0f, 1.0f, 1.0f),
		//p_ui, basic_params, TYPE_COLORSWATCH, IDC_CLR_SPECULAR,
		p_end,
	ns_mat_emittance, _T("emittance"), TYPE_RGBA, 0, IDS_MAT_EMITTANCE,
		p_default, Color(0.0f, 0.0f, 0.0f),
	...
	ns_mat_selfillumon, _T("useSelfIllumColor"), TYPE_BOOL, 0, IDS_MAT_SELFILLUMON,
		p_default, FALSE,
		p_end,
	ns_mat_selfillumclr, _T("selfillumclr"), TYPE_RGBA, 0, IDS_MAT_SELFILLUMCLR,
		p_default, Color(0.0f, 0.0f, 0.0f),
		p_end,
	ns_mat_selfillum, _T("selfillum"), TYPE_FLOAT, 0, IDS_MAT_SELFILLUM,
		p_default, 0.0f,
		p_end,
	ns_mat_glossiness, _T("glossiness"), TYPE_FLOAT, 0, IDS_MAT_GLOSSINESS,
		p_default, 0.0f,
		p_range, 0.0, 200.0,
		p_end,
	ns_mat_speclevel, _T("specularLevel"), TYPE_FLOAT, 0, IDS_MAT_SPECLEVEL,
		p_default, 1.0f,
		p_range, 0.0, 999.0,
		p_end,
	ns_mat_softenlevel, _T("softenlevel"), TYPE_FLOAT, 0, IDS_MAT_SOFTENLEVEL,
		p_default, 0.0f,
		p_end,
	ns_mat_shininess, _T("shininess"), TYPE_FLOAT, 0, IDS_MAT_SHININESS,
		p_default, 10.0f,
		p_end,
	ns_mat_alpha, _T("alpha"), TYPE_FLOAT, 0, IDS_MAT_ALPHA,
		p_default, 1.0f,
		p_end,
	ns_mat_dither, _T("Dither"), TYPE_BOOL, 0, IDS_MAT_DITHER,
		p_default, FALSE,
		p_end,
	//////////////////////////////////////////////////////////////////////////
